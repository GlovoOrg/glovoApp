...
public class CategoryService extends BaseService<Category> {
    ...
    public Category createCategory(String name, MultipartFile image) {
        try {
            ...
            createImageRecord(image, "categories", EntityType.Category, savedCategory.getId());
    ...
    @Transactional
    public Category updateCategory(Long categoryId, @Valid CategoryUpdateRequest request) {
        try {
    ...
    @Transactional
    public Category patchCategory(Long id, @Valid CategoryPatchRequest request) {
